...
$query = "SELECT * FROM country_sip_error";
$queryCount = "SELECT COUNT(country) as count FROM country_sip_error";
$params = [];

//Recherche par direction, date, country
if(!empty($_GET['q1']) and !empty($_GET['q2']) and !empty($_GET['q3'])){
	$query .= " WHERE direction LIKE :direction AND start_date LIKE :start_date AND country LIKE :country";
    $queryCount .= " WHERE direction LIKE :direction AND start_date LIKE :start_date AND country LIKE :country";
    $params['direction'] = '%' . $_GET['q1'] . '%';
	$params['start_date'] = '%' . $_GET['q2'] . '%';
    $params['country'] = '%' . $_GET['q3'] . '%'; 
}
...
//Recherche par direction, country
if(!empty($_GET['q1']) and empty($_GET['q2']) and !empty($_GET['q3'])){
	$query .= " WHERE direction LIKE :direction AND country LIKE :country";
    $queryCount .= " WHERE direction LIKE :direction AND country LIKE :country";
	$params['direction'] = '%' . $_GET['q1'] . '%';
    $params['country'] = '%' . $_GET['q3'] . '%';
}

//Recherche par date, country
if(empty($_GET['q1']) and !empty($_GET['q2']) and !empty($_GET['q3'])){
	$query .= " WHERE start_date LIKE :start_date AND country LIKE :country";
    $queryCount .= " WHERE start_date LIKE :start_date AND country LIKE :country";
	$params['start_date'] = '%' . $_GET['q2'] . '%';
    $params['country'] = '%' . $_GET['q3'] . '%';
}
...
<tr>
                       ...
                       <td> <div class="form-group">
                        ...
                        <td><div class="form-group">
                            <input type="text" class="form-control" name="q3" placeholder="Recherche par pays" value="<?= htmlentities($_GET['q3'] ?? null)?>">		
                        </div></td>
