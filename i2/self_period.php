...
$query = "SELECT direction, carrier, sum(answered) calls, sum(duration_min) duration FROM carrier_overview";
$queryCount = "SELECT count(a.direction) count from (select direction, carrier, sum(answered) FROM carrier_overview";
$params = [];
...
if(!empty($_GET['sort']) && in_array($_GET['sort'], $sortable)){
    ...
    $query .= " ORDER BY direction, carrier";
}
