...
$query = "SELECT * FROM carrier_sip_error";
$queryCount = "SELECT COUNT(carrier) as count FROM carrier_sip_error";
$params = [];
...
<tr>
                       ...
                       <td> <div class="form-group">
                            <input type="text" class="form-control" name="q1" placeholder="Carrier Name" value="<?= htmlentities($_GET['q1'] ?? null)?>">		
                        </div></td>
                        <td><div class="form-group">
		    ...
		    <table class="table table-striped">
                        <thead>
                            <tr>
                                <th>direction</th>
                                <th>start_date</th>
                                <th>_____________carrier_name_____________ </th>	
                                <th>attempt</th>
                                <th>SIP_0</th>
                                <th>SIP_1</th>
                                <th>SIP_2</th>
