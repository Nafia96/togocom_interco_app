...
$query = "SELECT * FROM country_traffic";
$queryCount = "SELECT COUNT(country) as count FROM country_traffic";
$params = [];
$sortable = ["direction", "start_date", "country", "attempt", "ner", "asr", "acd_sec"];
...
if(!in_array($_GET['direction'], $direction_list) && !empty($_GET['q']) && empty($_GET['q1']) && empty($_GET['q2'])){
    ...
    $queryCount .= " WHERE country LIKE :country AND start_date = CURRENT_DATE-1";
    $params['country'] = '%' . $_GET['q'] . '%';
}
...
if(in_array($_GET['direction'], $direction_list) && !empty($_GET['q']) && empty($_GET['q1']) && empty($_GET['q2'])){
    ...
    $queryCount .= " WHERE direction LIKE :direction AND country LIKE :country AND start_date = CURRENT_DATE-1";
	$params['direction'] = '%' . $_GET['direction'] . '%';
    $params['country'] = '%' . $_GET['q'] . '%';
}
...
if(!empty($_GET['sort']) && in_array($_GET['sort'], $sortable)){
    ...
    $query .= " ORDER BY start_date desc, country";
}
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h2 class="h2"> Country Overview </h2>
        <div class="btn-toolbar mb-2 mb-md-0">
            <div class="float-right">
                <a href="export_country_overview.php" class="btn btn-success"><i class="dwn"></i> Export to CSV</a>
            </div>
        </div>
    </div>            
<br/>
...
<tr>
                        ...
                        <td><div class="form-group">
                            <input type="text" class="form-control" name="q" placeholder="Country Name" value="<?= htmlentities($_GET['q'] ?? null)?>">		
                        </div></td>
