...
$query = "SELECT * FROM hourly_network_carrier";
$queryCount = "SELECT COUNT(start_hour) as count FROM hourly_network_carrier";
$params = [];
$sortable = ["direction", "start_date", "start_hour", "network", "carrier", "attempt", "ner", "asr", "acd_sec"];
...
<tr>
                        ...
                        <td><div class="form-group">
                            <input type="date" class="form-control" name="q" placeholder="Start_date" value="<?= htmlentities($_GET['q'] ?? null)?>">	
                        </div></td> 
                        </div></td>
