...
$queryCount = "select COUNT(a.start_date) count FROM (select start_date, carrier, sum(nb_calls) FROM `charge`";
$params = [];
$sortable = ["direction", "start_date", "carrier", "nb_calls", "volume_min", "charge_euro", "charge_cfa"];
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h2 class="h2"> Daily Charge Carrier </h2>
        <div class="btn-toolbar mb-2 mb-md-0">
            <div class="float-right">
                <a href="export_ch_daily_carrier.php" class="btn btn-success"><i class="dwn"></i> Export to CSV</a>
            </div>
        </div>
    </div>              
<br/>
