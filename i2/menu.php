...
<html lang="en">
    <head>
        ...
        <!-- Favicons -->
        <link rel="apple-touch-icon" href="logoi.png" sizes="180x180">
        <link rel="icon" href="logoi.png" sizes="32x32" type="image/png">
        <link rel="icon" href="logoi.png" sizes="16x16" type="image/png">
        <link rel="manifest" href="logoi.png">
        <link rel="mask-icon" href="logoi.png" color="#712cf9">
    ...
    <body>   
        <header class="navbar navbar-expand-md navbar-dark bg-dark mb-4">
            <div class="container-fluid">
                <a class="navbar-brand" href="#"><img src="logoi.png" alt="logo" width="75" height="55"/></a>
