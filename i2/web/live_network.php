...
$query = "SELECT * FROM live_network";
$queryCount = "SELECT COUNT(start_date) as count FROM live_network";
$params = [];
...
// #1 Recherche par direction, start_hour, network
if(in_array($_GET['direction'], $dirList) && in_array($_GET['start_hour'], $hourList) and !empty($_GET['q'])){
...
// #5 Recherche par direction, start_hour
if(in_array($_GET['direction'], $dirList) && in_array($_GET['start_hour'], $hourList) and empty($_GET['q'])){
...
// #7 Recherche par start_hour, carrier
if(!in_array($_GET['direction'], $dirList) && in_array($_GET['start_hour'], $hourList) and !empty($_GET['q'])){
...
<tr>
                        ...
                        <td><div class="form-group">
                            <input type="text" class="form-control" name="q" placeholder="Network" value="<?= htmlentities($_GET['q'] ?? null)?>">		
                        </div></td>
