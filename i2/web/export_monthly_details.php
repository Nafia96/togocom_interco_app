...
$query = "SELECT substr(start_date,1,7) start_month, carrier, details, sum(duration) duration, tarif, round(sum(revenue_cfa)/655.957) revenue_euro, round(sum(revenue_cfa)) revenue_cfa FROM `revenu`";
$params = [];
...
array_push($list, array("start_month, carrier, details, volume_min, tarif, revenue_euro, revenue_cfa"));
