...
$query = "SELECT substr(start_date,1,7) start_month, carrier, sum(duration) duration, round(sum(revenue_cfa)) revenue_cfa FROM `revenu`";
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h2 class="h2"> Monthly Carrier </h2>
