...
$query = "SELECT substr(start_date,1,7) start_month, carrier, details, sum(duration) duration, tarif, round(sum(revenue_cfa)) revenue_cfa FROM `revenu`";
...
$params = [];
$sortable = ["start_month", "carrier", "duration", "revenue_cfa"];
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h2 class="h2"> Monthly Details </h2>
