...
$queryCount = "SELECT COUNT(a.start_date) as count from (select start_date, sum(nb_calls) FROM `charge` group by start_date)a";
$params = [];
$sortable = ["start_date", "nb_calls", "volume_min", "charge_euro", "charge_cfa"];
...
if(!empty($_GET['sort']) && in_array($_GET['sort'], $sortable)){
	...
	$query .= " ORDER BY direction, start_date desc";
}
...
?>
   <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h2 class="h2"> Daily Charge Summary </h2>
        <div class="btn-toolbar mb-2 mb-md-0">
            <div class="float-right">
                <a href="export_ch_daily_summary.php" class="btn btn-success"><i class="dwn"></i> Export to CSV</a>
            </div>
        </div>
    </div>                 
<br/>
