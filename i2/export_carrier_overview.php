...
$query = "SELECT direction, start_date, carrier, attempt, ner, asr, acd_sec FROM carrier_traffic";
...
array_push($list, array("direction, start_date, carrier, attempt, ner, asr, acd_sec"));
