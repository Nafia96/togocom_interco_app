...
$query = "SELECT direction,start_date,network_name,carrier_name,trunk_id,attempt,ner,asr,acd,SIP_0,SIP_1,SIP_2,SIP_400,SIP_403,SIP_404,SIP_408,SIP_410,SIP_480,SIP_481,SIP_482,SIP_483,SIP_484,SIP_486,SIP_487,SIP_500,SIP_501,SIP_502,SIP_503,SIP_504,SIP_603,SIP_604,SIP_606 FROM network_carrier_sip_error";
$params = [];
...
if(in_array($_SESSION['direction'], $direction_list) && !empty($_SESSION['q1']) && !empty($_SESSION['q2']) && !empty($_SESSION['q3']) && !empty($_SESSION['q4'])){
    ...
    $params['network_name'] = '%' . $_SESSION['q1'] . '%'; 
    $params['carrier_name'] = '%' . $_SESSION['q2'] . '%';
...
array_push($list, array("direction,start_date,network_name,carrier_name,trunk_id,attempt,ner,asr,acd,SIP_0,SIP_1,SIP_2,SIP_400,SIP_403,SIP_404,SIP_408,SIP_410,SIP_480,SIP_481,SIP_482,SIP_483,SIP_484,SIP_486,SIP_487,SIP_500,SIP_501,SIP_502,SIP_503,SIP_504,SIP_603,SIP_604,SIP_606"));
