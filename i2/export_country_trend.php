...
$query = "SELECT direction, start_date, country, answered, duration_min FROM country_traffic";
$params = [];
...
array_push($list, array("direction", "start_date", "country", "answered", "duration_min"));
