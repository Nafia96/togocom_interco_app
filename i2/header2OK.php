            ...
            <div class="row">
                <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                    <div class="position-sticky pt-3 sidebar-sticky">   
                        ...
                        <?php if(in_array($_SERVER['SCRIPT_NAME'],$traffic_qos)) : ?>
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button type="button" class="accordion-button" data-bs-toggle="collapse" data-bs-target="#accordion1">Traffic QoS</button>
                                </h2>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#accordion2">Total Range</button>
                                </h2>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#accordion3">TroubleShooting</button>
                                </h2>
                            ...
                            <?php elseif(in_array($_SERVER['SCRIPT_NAME'],$total_range)) : ?>
                                <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#accordion1">Traffic QoS</button>
                                </h2>
                                <section class="accordion-body collapse" id="accordion1" data-bs-parent="#accordionContact">
                                    <ul class="nav flex-column mb-2">
                                        <?= nav_link('/daily_overview.php', 'Daily Overview'); ?> 
                                        <?= nav_link('/top50_dest_overview.php', 'Top50 Dest Overview'); ?>
                                        <?= nav_link('/carrier_overview29.php', 'Carrier Overview'); ?>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button type="button" class="accordion-button" data-bs-toggle="collapse" data-bs-target="#accordion2">Total Range</button>
                                </h2>
                                <section class="accordion-body collapse show" id="accordion2" data-bs-parent="#accordionContact">
                                    <ul class="nav flex-column mb-2">
                                        <?= nav_link('stat_carrier_group.php', 'Carrier Grouping'); ?> 
                                        <?= nav_link('/stat_network_group.php', 'Network Grouping'); ?> 
                                        <?= nav_link('/stat_network_carrier_group.php', 'Network Carrier'); ?>          
                            ...
                            <?php elseif(in_array($_SERVER['SCRIPT_NAME'],$troubleshooting)) : ?>
                                <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#accordion1">Traffic QoS</button>
                                </h2>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button type="button" class="accordion-button" data-bs-toggle="collapse" data-bs-target="#accordion3">TroubleShooting</button>
                                </h2>
                                <section class="accordion-body show" id="accordion3" data-bs-parent="#accordionContact">
                                    <ul class="nav flex-column mb-2">
                                        <?= nav_link('/daily_sip_error.php', 'Daily SIP Error'); ?>  
                                        <?= nav_link('/carrier_trunkid_sip_error.php', ' Carrier Trunk-ID SIP Error'); ?>  
                                        <?= nav_link('/network_sip_error.php', 'Network SIP Error'); ?>  
