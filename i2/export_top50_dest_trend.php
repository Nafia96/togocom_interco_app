...
$query = "SELECT direction, start_date, network, answered, duration_min FROM network_traffic2";
$params = [];
...
array_push($list, array("direction, start_date, network, answered, volume_min"));
