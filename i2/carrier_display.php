...
<tr>
                        <td> <div class="form-group">
                            <select class="form-select form-select" name="direction">
					                    <option selected></?= $_GET['direction'] ?? "-- Direction --"?></option>
...
-->
                        ...
                        <tbody>  
                            <?php foreach($carriers as $carrier): ?>
                                <tr>
                                    <td><?= $carrier['direction']?></td>
                                    <td><?= $carrier['start_date']?></td>
                                    <td><?= $carrier['carrier']?></td>
                                    <td><?= $carrier['answered']?></td>	
                                    <td><?= $carrier['duration_min']?></td>               	
                                </tr>
			    <?php endforeach ?>	
			</tbody>
		     </table>
