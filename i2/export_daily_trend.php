...
$query = "SELECT direction, start_date, answered, duration_min FROM `daily_traffic`";
$params = [];
...
if(!in_array($_SESSION['direction'], $dirList) && empty($_SESSION['q1']) && empty($_SESSION['q2'])){
...
array_push($list, array("direction, start_date, nb_call, volume_min"));
