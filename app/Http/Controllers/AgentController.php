...
class AgentController extends Controller
{
    ...
    public function agent_register(Request $request)
    {
        ...
        return redirect('liste_agent')->with('flash_message_success', 'Agent ajouté avec succès!');
    ...
    public function liste_agent()
    {
        ...
        return view('agents.liste_agents', compact('agents'));
    }

    public function delete_agent_liste()
    {
