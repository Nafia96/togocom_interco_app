...
@section('title','Liste des agents suprimés')
@section('breadcrumb')
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Dashboard</a></li>

        <li class="breadcrumb-item active" aria-current="page">Liste des agents supprimés</li>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4>Liste des agents suprimés</h4>
                </div>
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td style="width:16%">
                                        ...
                                        <span data-toggle="tooltip" data-placement="top" title="Reaciver cette agence">
                                            <a class=" delete-confirm mb-2 btn btn-sm btn-success" href="/activate_agent/{{ $agent->id }}">
...
$('.delete-confirm').on('click', function (event) {
    ...
    swal({
        title: 'Voulez-vous vraiment réactiver cet agent?',
        text: 'Cet agent poura acceder à nouveau aux données!',
        icon: 'warning',
        buttons: ["Annuler", "Oui!"],
    }).then(function(value) {
        if (value) {
