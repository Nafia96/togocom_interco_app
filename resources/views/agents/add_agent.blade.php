...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Ajouter un agent</li>
        </ol>
    </nav>
@stop
...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h4>Remplissez les informations de l'agent</h4>
        </div>
        <div class="card-body">

            <form action="{{ url('add_agent') }}" enctype="multipart/form-data" method="post">
                {{ csrf_field() }}
