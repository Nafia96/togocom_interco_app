...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Journal des Actions</li>
    </ol>
                        ...
                        <table class="table table-striped table-hover" id="tableExpor" style="width:100%;">
                            <thead>
                                <tr>
                                    ...
                                    <th class="recherche">Utilisateur</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $journal->admin->last_name }} {{ $journal->admin->first_name }}</td>
