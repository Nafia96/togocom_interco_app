...
@section('title','Liste des clients suprimés')
@section('breadcrumb')
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Dashboard</a></li>

        <li class="breadcrumb-item active" aria-current="page">Liste des clients supprimés</li>
        <div class="d-flex justify-content-end container-fluid mt-n3">
            <a href="{{route('add_client')}}" class="btn btn-primary ">Ajouter un client</a>
        </div>
    </ol>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4>Liste des clients suprimés</h4>
                </div>
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td style="width:16%">
                                        ...
                                        <span data-toggle="tooltip" data-placement="top" title="Reaciver cette agence">
                                            <a class=" delete-confirm mb-2 btn btn-sm btn-success" href="/activate_client/{{ $client->id }}">
...
$('.delete-confirm').on('click', function (event) {
    ...
    swal({
        title: 'Voulez-vous vraiment réactiver cet client?',
        text: 'Tous les comptes et tous opérations du client seront automatiquement réactiver. Après cette action, il est possible de désactiver manuellement les comptes du client que vous avez désactivés précédemment!',
        icon: 'warning',
        buttons: ["Annuler", "Oui!"],
    }).then(function(value) {
        if (value) {
