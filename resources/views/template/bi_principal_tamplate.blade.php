                ...
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="dropdown">
                            ...
                            <a href="{{ url('/lunchpadb') }}" class="nav-link"><i
                        ...
                        <li
                            class="dropdown  {{ Request::is('interco_details') ? 'active' : '' }}
                                 ">
                        ...
                        <li
                            class="dropdown  {{ Request::is('add_credit') ? 'active' : '' }}
                      ">
