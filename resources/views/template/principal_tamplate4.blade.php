        ...
        <div class="main-wrapper main-wrapper-1">
          ...
          fa-user"></i> Profile
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="{{ route('roaming') }}"> <img alt="image"
                                src="{{ asset('assets/img/logo.png') }}" class="header-logo" /> <span
                                class="logo-name">ROAMING
                            </span>
                        </a>
                    </div>
                    <ul class="sidebar-menu">
                        ...
                        <li class="dropdown">
                            ...
                            <a href="{{ url('/roaming') }}" class="nav-link"><i
                        ...
                        <li class="dropdown">
                            ...
                            <a href="{{ url('/iot_discount') }}" class="nav-link"><i
                                    data-feather="monitor"></i><span>IOT discount</span></a>
            ...
            <div class="main-content">
                ...
                @include('roaming.add_IOT_discount')
