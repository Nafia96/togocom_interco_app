...
<head>
    ...
    <title>Pivot Pays Mensuel</title>
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                    ...
                    <span>Analyse Pivot Pays – Mensuelle</span>
                </div>
                    ...
                    <table class="table table-bordered table-hover table-striped align-middle">
                        ...
                        <tbody>
                            ...
                            @foreach ($countryGroups as $country => $records)
                                <tr>
                                    <td>
                                        <a href="{{ route('billingPivotNetCarrier', array_merge(request()->except('page'), ['orig_country_name' => $country, 'view_type' => request('view_type', 'month')])) }}"
