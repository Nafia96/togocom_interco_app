    ...
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex align-items-center" style="gap:8px;">
                <div class="me-2 d-flex" style="gap:6px;">
                    ...
                    <a href="{{ route('networkkpi', request()->all()) }}" class="btn btn-sm btn-secondary" title="Network KPI">
        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header" style="background: linear-gradient(90deg, #133272 0%, #1e4a98 100%); color: #ffd100; font-weight: 700; padding: 0.75rem 1.25rem; border-bottom: 3px solid #004aad;">
                        <h4 style="margin: 0;">Résultat du filtre</h4>
                    </div>
                    <div class="card-body">
