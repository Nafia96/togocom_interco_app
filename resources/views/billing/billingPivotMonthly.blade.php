...
<head>
    ...
    <title>Pivot Facturation - Vue Mensuelle</title>
...
<body>
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                    ...
                    <span class="pivot-header-title">Analyse Pivot Mensuelle – Facturation par opérateur</span>
                </div>
            ...
            <div class="card-body">
                    ...
                    <table id="pivotTableOps" class="table table-bordered table-hover table-striped align-middle">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                @foreach ($months as $month)
                                    <td class="text-end">
                                        {{ $totals[$month] > 0 ? number_format($totals[$month], 0, ',', ' ') : '-' }}
                                    </td>
                                @endforeach
                ...
                <div class="mt-5" id="chartsValeurs">
                    <h5 class="mb-3">📊 Évolution mensuelle par opérateur</h5>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // === Graphe Évolution mensuelle par opérateur ===
            ...
            const datasets = opNames.map((op, idx) => {
                const data = months.map(m => {
                    const year = parseInt(m.substring(0, 4), 10);
                    const monthNum = parseInt(m.substring(5, 7), 10);
                    const found = operators[op].find(r => r.year === year && r.month === monthNum);
