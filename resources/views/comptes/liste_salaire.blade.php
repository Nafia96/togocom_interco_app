                                ...
                                <tr>
                                    ...
                                    <td style="width:16%">
                                        <span data-toggle="tooltip" data-placement="top" title="Voir les informations du compte en détail">
                                            <a class=" mb-2 btn btn-sm btn-success" data-toggle="modal" data-target="{{'#voirSalaireModal'.$compte->id}}">
                                        ...
                                        <span data-toggle="tooltip" data-placement="top" title="Modifier les informations du compte ">
                                            <a class=" mb-2 btn btn-sm btn-info" href="{{url('update_salaire/'.$compte->id)}}">
                                        ...
                                        <span data-toggle="tooltip" data-placement="top" title="Supprimer cet compte ">
                                            <a class=" delete-confirm mb-2 btn btn-sm btn-danger" href="{{url('delete_salaire/'.$compte->id)}}">
