...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Liste des comptes tontines supprimés</li>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4>Liste des comptes tontines supprimés</h4>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-striped table-hover" id="tableExpor" style="width:100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $compte->client->last_name.' '.$compte->client->first_name}} </td>
                                    ...
                                    <td style="width:16%">
                                        ...
                                        <span data-toggle="tooltip" data-placement="top" title="Reaciver cet compte">
                                            <a class=" delete-confirm mb-2 btn btn-sm btn-success" href="/activate_tontine/{{ $compte->id }}">
...
$('.delete-confirm').on('click', function (event) {
    ...
    swal({
        title: 'Voulez-vous vraiment réactiver cet compte ?',
        text: 'Tous les opérations reliées à ce compte seront automatiquement réactiver. Après cette action, il est possible de désactiver manuellement les opérations reliées à ce compte que vous avez désactivés précédemment!',
        icon: 'warning',
        buttons: ["Annuler", "Oui!"],
    }).then(function(value) {
        if (value) {
