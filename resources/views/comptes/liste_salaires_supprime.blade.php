...
@section('title','Liste des comptes salaires')
@section('breadcrumb')
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Dashboard</a></li>

        <li class="breadcrumb-item active" aria-current="page">Liste des comptes salaires</li>
        <div class="d-flex justify-content-end container-fluid mt-n3">
            <a href="{{route('add_salaire')}}" class="btn btn-primary ">Ajouter un compte </a>
        </div>
    </ol>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4>Liste des comptes salaires</h4>
                </div>
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td style="width:16%">
                                        ...
                                        <span data-toggle="tooltip" data-placement="top" title="Reaciver cet compte">
                                            <a class=" delete-confirm mb-2 btn btn-sm btn-success" href="/activate_salaire/{{ $compte->id }}">
...
$('.delete-confirm').on('click', function (event) {
    ...
    swal({
        ...
        text: 'Cet compte  sera desormais opperationel!',
        icon: 'warning',
        buttons: ["Annuler", "Oui!"],
    }).then(function(value) {
        if (value) {
