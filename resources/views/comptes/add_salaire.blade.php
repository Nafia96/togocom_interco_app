...
@section('title', 'Création d\'un compte salaire')

@section('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
            <li class="breadcrumb-item active" aria-current="page">Création d'un compte salaire</li>
        </ol>
    </nav>
@stop
...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h4>Ajouter un compte salaire</h4>
        </div>
        <div class="card-body">

            <form action="{{ url('add_salaire') }}" enctype="multipart/form-data" method="post">
                @csrf

                <div class="form-row">


                    <label>Date d'salaire</label>
                ...
                <div class="form-row">
                        ...
                        <label for="inputEmail4">Premier versement (Salaire)</label>
