...
@section('title', 'Modification d\'un compte épargne')

@section('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
            <li class="breadcrumb-item active" aria-current="page">Midification d'un compte épargne</li>
        </ol>
    </nav>
@stop
...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h4>Modification d'un compte épargne</h4>
        </div>
        <div class="card-body">

            <form action="{{ url('save_epargne_update') }}" enctype="multipart/form-data" method="post">
                @csrf
            ...
            <input type="hidden" name="id_compte" value="{{$compte->id}}">
                ...
                <div class="form-row">
                        ...
                        <label for="inputEmail4">Premier verssement (Epargne)</label>
