...
@section('title', 'Modification d\'un compte tontine')

@section('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
            <li class="breadcrumb-item active" aria-current="page">Midification d'un compte tontine</li>
        </ol>
    </nav>
@stop
...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h4>Modification d'un compte tontine</h4>
        </div>
        <div class="card-body">

            <form action="{{ url('save_tontine_update') }}" enctype="multipart/form-data" method="post">
                @csrf
            ...
            <input type="hidden" name="id_compte" value="{{$compte->id}}">
                ...
                <div class="form-row">
                    ...
                    <select name="client_id" id="demo" disabled>
                            ...
                            <option selected value="{{ $compte->client->id }}">
                                <div class="form-group col-6">{{ $compte->client->user->last_name . ' ' . $compte->client->user->first_name }}</option>
                ...
                <div class="form-row">
                        ...
                        <input name="taux_cotisation" type="number" class="form-control  @error('taux_cotisation') is-invalid @enderror"
                            value="{{$compte->taux_cotisation }}" placeholder="" required>
