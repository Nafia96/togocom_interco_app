...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Liste des comptes dépôts supprimées</li>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4>Liste des comptes dépôts supprimées</h4>
                </div>
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td style="width:16%">
                                        ...
                                        <span data-toggle="tooltip" data-placement="top" title="Reaciver cet compte">
                                            <a class=" delete-confirm mb-2 btn btn-sm btn-success" href="/activate_epargne/{{ $compte->id }}">
