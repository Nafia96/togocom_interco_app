<div class="modal fade bd-example-modal-lg" id="{{ 'retraitModal' . $compte->id }}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="row container-fluid mt-3 ">
                    <div class="mt-3 col-12 text-center  m-auto">
                        <h6 class="modal-title" id="myLargeModalLabel">Opération de rétrait sur le compte </h6>
                    </div>
                </div>
            ...
            <div class="modal-body">
                <form action="retrait" enctype="multipart/form-data" method="post">
                    @csrf
                    ...
                    @if (isset($compte))
                        ...
                        <div class="mt-3  col-12 text-center  m-auto">
                            ...
                            <div class="author-box-name mb-3">
                                <h5>{{ $compte->client->user->last_name }} {{ $compte->client->user->first_name }}
                                </h5>
                            </div>
                        </div>
                        ...
                        <div class="tab-content tab-bordered" id="myTab3Content">
                            <div class="tab-pane fade show active" id="about" role="tabpanel"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-6 b-r">
                                        ...
                                        <br>
                                        <p class="text-muted">
                                            {{ $compte->client->user->last_name . ' ' . $compte->client->user->first_name }}
                                        </p>
                                    </div>
                                </div>
                                <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                <label>La somme à Retirer</label>
            ...
            <div class="d-flex justify-content-end container-fluid">
                ...
                <button type="submit" class="btn btn-primary waves-effect mb-2">Faire le retrait</button>
            </div>
        </div>
        @endif
