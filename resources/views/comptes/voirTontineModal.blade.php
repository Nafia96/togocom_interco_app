<div class="modal fade bd-example-modal-lg"  id="{{'voirTontineModal'.$compte->id}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
aria-hidden="true">
        ...
        <div class="modal-header">
            ...
            <div class="row container-fluid mt-3 ">
                <div class="mt-3 col-12 text-center  m-auto" >
                    <h6 class="modal-title" id="myLargeModalLabel">Les détails sur le compte tontine </h6>
                </div>
            </div>
            ...
            <div class="tab-pane fade show active" id="about" role="tabpanel" aria-labelledby="home-tab2" style="background-color:#E5E8E8;  border-radius: 13px;">
                <div class="row">
                    <div class="col-md-6 col-6 b-r">
                        ...
                        <br>
                        <p style="background-color: rgb(252, 246, 246)" class="text-muted">{{ $compte->account_number }}</p>
                    </div>
                    <div class="col-md-6 col-6 b-r">
                ...
                <div class="row">
                    <div class="col-md-6 col-6 b-r">
                        ...
                        <br>
                        <p class="text-muted">{{ $compte->taux_cotisation }}</p>
                    </div>
                    <div class="col-md-6 col-6 b-r">
                        <strong>Solde</strong>
                        <br>
                ...
                <div class="row">
                    ...
                    @endif
                    <div class="col-md-6 col-6 b-r">
                        <strong>Jours cotisé</strong>
                        <br>
                        <p class="text-muted">{{ $compte->nombre_de_retrait }} Jours</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 col-6 b-r">
