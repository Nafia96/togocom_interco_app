<div class="modal fade bd-example-modal-lg"  id="{{'voirSalaireModal'.$compte->id}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
aria-hidden="true">
        ...
        <div class="modal-header">
            ...
            <div class="row container-fluid mt-3 ">
                <div class="mt-3 col-12 text-center  m-auto" >
                    <h6 class="modal-title" id="myLargeModalLabel">Les détails sur le compte salaire </h6>
                </div>
            </div>
