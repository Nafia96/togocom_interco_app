...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{route('agence_dashboard')}}">Dashboard</a></li>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4>Liste des operations sur le compte de {{ $client->user->last_name.'a
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <span data-toggle="tooltip" data-placement="top" title="Annuler opération">
                                        <a class=" delete-confirm mb-2 btn btn-sm btn-danger" href="{{url('delete_tontine/'.$operation->id)}}">
