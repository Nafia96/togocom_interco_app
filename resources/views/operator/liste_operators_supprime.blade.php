...
@section('title','Liste des opérateurs supprimés')
@section('breadcrumb')
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Dashboard</a></li>

        <li class="breadcrumb-item active" aria-current="page">Liste des opérateurs supprimé</li>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4>Liste des opérateurs supprimées</h4>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="width:10%">
                                        ...
                                        <span data-toggle="tooltip" data-placement="top" title="Reactiver cet opérateurs">
                                            <a class=" delete-confirm mb-2 btn btn-sm btn-success" href="/activate_operator/{{ $operator->id }}">
...
$('.delete-confirm').on('click', function (event) {
    ...
    swal({
        title: 'Voulez-vous vraiment réactiver cet opérateur?',
        text: 'Cet opérateur va apparaitre nouveau dans la liste des opérateurs!',
        icon: 'warning',
        buttons: ["Annuler", "Oui!"],
    }).then(function(value) {
        if (value) {
