...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Ajouter un opérateur</li>
        </ol>
    </nav>
@stop
...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h4>Remplissez les informations de l'opérateur</h4>
        </div>
        <div class="card-body">

            <form action="{{ url('add_operator') }}" enctype="multipart/form-data" method="post">
                {{ csrf_field() }}
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input name="tel" type="tel" class="form-control  @error('tel') is-invalid @enderror"
                            placeholder="" value="{{ @old('tel') }}" required>
                ...
                <div class="form-row ">
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" name="adresse" class="form-control @error('adresse') is-invalid @enderror"
                            id="" value="{{ @old('adresse') }}" placeholder="">
                ...
                <div class="form-group">
                    <label>Description de l'opérateur</label>
