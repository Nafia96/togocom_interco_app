...
@section('title', 'Liste de toutes les opérations')
@section('breadcrumb')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Liste de toutes les opérations</h4>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table table-striped table-hover" id="tableExpor" style="width:100%;">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="recherche">Type de facture</th>
                                        <th class="recherche">Montant</th>
                                        <th class="recherche">Nouvelle dette</th>
                                        <th class="recherche">Nouvelle créance</th>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($operations as $operation)
                                        <tr>
                                            ...
                                            <td >
                                                <a style="color: #ec1f28; font-weight: bold;" href="{{ url('operations_list/' . $operation->operator->id) }}">
                                            ...
                                            <td>{{ $operation->amount . $operation->operator->currency }}</td>
                                            <td>{{ $operation->new_debt . $operation->operator->currency }}</td>
                                            <td>{{ $operation->new_receivable . $operation->operator->currency }}</td>
                                            ...
                                            <td style="width:10%">
                                                <span data-toggle="tooltip" data-placement="top"
                                                    ...
                                                    <a class=" mb-2 btn btn-sm btn-dark" data-toggle="modal"
                                                        data-target="{{ '#voirOperatorModal' . $operation->id }}">
