                                ...
                                <tr>
                                    ...
                                    <span data-toggle="tooltip" data-placement="top"
                                     ...
                                     <span data-toggle="tooltip" data-placement="top" title="Toutes les opérations">
                                        ...
                                        <span data-toggle="tooltip" data-placement="top" title="Modifier les informations de l'opérateur">
                                            <a class=" mb-2 btn btn-sm btn-info" href="{{url('update_operator/'.$operator->id)}}">
                                        ...
                                        <span data-toggle="tooltip" data-placement="top" title="Supprimer cet opérateur">
                                            <a class=" delete-confirm mb-2 btn btn-sm btn-danger" href="/delete_operator/{{ $operator->id }}">
