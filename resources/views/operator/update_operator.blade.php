...
@section('title', "Modification d'un opérateur")
...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h4>Modifiez les informations de l'opérateur</h4>
        </div>
        <div class="card-body">

            <form action="{{ url('update_operator') }}" enctype="multipart/form-data" method="post">
                {{ csrf_field() }}
