...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#"><i class="far fa-file"></i> Liste de opérateurs</a></li>
            <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-list"></i> Informations de </li>
...
<div class="row">
        ...
        <div class="card card-statistic-2">
            ...
            <div class="card-wrap">
                <div class="card-header">
                    <h4 class="pull-right">CREANCE AVEC  {{$operator->name}}</h4>
                </div>
                <div class="card-body pull-right">
                    {{$op_account->receivable}} {{$operator->currency}}
                </div>
            </div>
    ...
    <div class="col-lg-4 col-md-4 col-sm-12">
        <div class="card card-statistic-2">
            ...
            <div class="card-wrap">
                <div class="card-header">
                    <h4 class="pull-right">NETTING AVEC  {{$operator->name}}</h4>
                </div>
                <div class="card-body pull-right">
                    {{$op_account->receivable - $op_account->debt}} {{$operator->currency}}
                </div>
            </div>
            <div class="card-chart">
    ...
    <div class="col-lg-4 col-md-4 col-sm-12">
        <div class="card card-statistic-2">
            ...
            <div class="card-wrap">
                <div class="card-header">
                    <h4 class="pull-right">DETTE AVEC  {{$operator->name}}</h4>
                </div>
                <div class="card-body pull-right">
                    {{$op_account->debt}} {{$operator->currency}}
