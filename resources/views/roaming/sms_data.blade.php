...
@section('content')
        ...
        <div class="col-xl-3 col-lg-6">
            <div class="card l-bg-cyan">
                <div class="card-statistic-3">
                    ...
                    <div class="card-content">
                        <h4 class="card-title">Free Roaming CEDEAO</h4>
                        <span>0</span>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item " aria-current="page"><i class="fas fa-list"></i> TARIFFS ROAMING OUT TOGOCOM (SMS et DATA) (Tarifs End-user en FCFA TTC ).
            </li>
