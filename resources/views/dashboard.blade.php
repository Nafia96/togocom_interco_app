...
$(document).ready(function() {
            ...
            $('#tableExpor0 thead tr .recherche').clone(true).appendTo('#tableExpor0 thead').addClass("rech");
            $('#tableExpor0 thead .rech ').each(function(i) {
                var title = $(this).text();
            ...
            var table = $('#tableExpor0').DataTable({
                orderCellsTop: true,
                fixedHeader: true,
                dom: 'Bfrtip',
                buttons: [
