                    ...
                    <div class="col-md-12">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-hover table-md">
                                <tr
                                    style="background-color: #03a04f; border: 1px solid white;
                                ...
                                @if ($operation->operation_type == '1' || $operation->operation_type == '2')
                                    ...
                                    <tr
                                        ...
                                        @if ($operation->invoice->invoice_type == 'real')
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-hover table-md">
                                    <tr
                                        style="background-color: #03a04f; border: 1px solid white;
                                            border-collapse: collapse;">
                                        <th class="text-center">CONTESTATION DE :</th>
                                        <th class="text-center">NOTE DE CREDIT </th>
                                        <th class="text-center">EN DIMINUTION DE:</th>
                ...
                <div class="col-lg-8">
                    <div class="text-md-left" style="font-size: 10px;">
                        <div class="float-lg-left mb-lg-0 mb-3">
                            ...
                            <strong> <span style="color: #03a04f; font-weight: bold;"> Avancer.</span> <span
                                    style="color: #fcca29; font-weight: bold;">Pour vous.</span> <span
                                    style="color: #ec1f28; font-weight: bold;">Pour Tous.</span> </strong>
                        </div>
